...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <p class="text-gray-400">Write and publish a new news article</p>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800 rounded-lg shadow p-6 border border-gray-700">
                    ...
                    <input type="text" id="title" name="title" required
                           class="w-full px-3 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                           value="{{ old('title') }}"
                ...
                <div class="bg-gray-800 rounded-lg shadow p-6 border border-gray-700">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            <label for="is_draft" class="ml-2 text-sm text-gray-300">Save as Draft</label>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_featured" class="ml-2 text-sm text-gray-300">Featured Article</label>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="is_breaking" class="ml-2 text-sm text-gray-300">Breaking News</label>
                        </div>
                    </div>
                </div>
...
@endpushass="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
